...
public class ChopinOp10No1Bar1RH extends MEL {
	...
	public ChopinOp10No1Bar1RH() {
		...
		Mask				tonicTriad			= mask(0, diatonicTriad);
		Mask				subdomTriad			= mask(3, diatonicTriad);
		Mask				domTriad			= mask(4, diatonicTriad);
		...
		MaskSequence		gfMaVTr				= maskSequence(gfMajorScale,domTriad);
		MaskSequence		gfMaVFifth			= maskSequence(gfMaVTr, mask(0, diatonicFifth));
		...
		VectorSequence		vs7					= vectorSequence(tripletSemis,gfMaVFifth, 1,2, 1,-1);
		VectorSequence		vs8					= vectorSequence(vs7,ret(inv(vs7)));
		
		PatternStructure 	patternStructure1	= patternStructure(vs4,vs0,vs1,vs2,vs3);
		PatternStructure	patternStructure2	= patternStructure(vs5,vs6,vs8);
	...
	public static void main(String[] args) {
		System.out.println(new ChopinOp10No1Bar1RH());
	}
}
