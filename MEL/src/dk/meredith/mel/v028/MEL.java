...
//		}
		...
		public String encode() {
			...
			while(!notesLeft.isEmpty()) {
				...
				if (n == 1) {
					String s = (firstTEC?"":",")+notesLeft;
					if (firstTEC) firstTEC = false;
					sb.append(s);
...
//					System.out.println("TEC: "+tec+" cr="+String.format("%.2f",cr));
				...
				String s = (firstTEC?"":",")+"translate("+bestTEC.getPattern().encode()+","+bestTEC.getTranslators()+")";
				if (firstTEC) firstTEC = false;
				sb.append(s);
...
//			System.out.println("s = "+s);
	...
	private static final String THIS_LANGUAGE_IDENTIFIER = "MEL28";
