...
public class MEL {
	...
	class DrawNoteSet extends PApplet {
		...
		private void drawNote(Note n) {
			float col = map(n.priority, 0, maxPriority, 0, 200);
			stroke(col);
			fill(0);
			strokeWeight(2);
			strokeCap(ROUND);
			...
			float d = map(n.priority, 0,maxPriority, 7,2);
			ellipse(x,y,d,d);
		}
	...
	private static final String THIS_LANGUAGE_IDENTIFIER = "MEL24";
