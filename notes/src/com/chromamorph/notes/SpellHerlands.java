...
public class SpellHerlands {

	public static void main(String[] args) {
		String inputDirectory = "/Users/dave/Documents/Work/Research/Data/Herlands/herlands_midi";
		String[] inputFileNames = new File(inputDirectory).list();
		Path parentDirectory = Paths.get(inputDirectory).getParent();
		String opdvDir = parentDirectory.toString()+"/herlands-opnd";
