...
public class MML2024 {
	public static void main(String[] args) {
		...
		for(String piece : new String[] {/*"Ravel",*/ "Bach"}) {
			...
			for (double MIN_OCC_COMPACTNESS : new double[] {0.5, 0.75, 1.0}) {
				...
				for(int MIN_PATTERN_SIZE : minPatternSizes) {
					for(boolean MID_TIME_POINT : new boolean[] {false, true}) {
						if (MIN_OCC_COMPACTNESS == 0.5 && MIN_PATTERN_SIZE == 11) continue;
						...
						if (piece.equals("Ravel")) {
							...
							MaxTranPats.OUTPUT_DIR_PATH = "/Users/susanne/Repos/omnisia/MaxTranPatsJava/output/MML2024/Ravel/Soucy";
