...
/**
 * 
 * This transformation class contains all 3d transformations that consist
 * of the following, in order:
 * 1. an optional reflection in the xy-plane
 * 2. a rotation around the x-axis
 * 3. a rotation around the y-axis
 * 4. a rotation around the z-axis
 * 5. a translation
 * 
 * Each transformation parameter, alpha, therefore consists of a quintuple,
 * <b,theta_x, theta_y, theta_z, v>
 * where
 * - b is in {1,-1}: b=1 implies no initial reflection; b=-1 implies reflection in xy-plane
 * - theta_x is angle in radians of rotation around x-axis
 * - theta_y is angle in radians of rotation around y-axis
 * - theta_z is angle in radians of rotation around z-axis
 * - v is translation vector
 * 
 * sigma(alpha) = < b, theta_x, theta_y, theta_z, v[0], v[1], v[2] >
 * 
 * Identity sigma is <1, 0, 0, 0, 0, 0, 0>
 * 
 * 
 * 
 ...
 *
 */
public class F_3RRT extends TransformationClass {
