...
public class TECQualityComparator implements Comparator<TEC> {
	...
	public static void main(String[] args) {
		...
		TEC tec1 = new TEC("T(P(p(2520,31),p(2880,31),p(3000,30),p(3420,30)),V(v(0,0),v(3600,0),v(5760,0)))",0);
		TEC tec2 = new TEC("T(P(p(120,31),p(1320,32),p(3960,31)),V(v(0,0),v(180,0),v(480,-4),v(4800,-1)))",0);
