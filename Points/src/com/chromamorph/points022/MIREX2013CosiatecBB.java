 ...
 * @date August 3, 2013
 * 
 * Runs COSIATEC and returns the bounding box patterns of the 
 * patterns generated, with minPatternSize set to 4.
 *
 */
public class MIREX2013CosiatecBB {
	public static void main(String[] args) {
		...
		MIREX2013Entries.PARAMETER_STRING = "minPatternSize=4,boundingBox=1";
